...
#drawing circles at the centre of the rectangles
...
#Drawing connecting lines between centers of the rectangles
cv2.line(image_rgb, (center1_x, center1_y),(center2_x, center2_y), (0, 255, 0), 3)
#adding text labels
font = cv2.FONT_HERSHEY_SIMPLEX
cv2.putText(image_rgb, 'region 1', (top_left1[0], top_left1[1] ), font, 0.7, (0, 255, 255), 2, cv2.LINE_AA)
...
#adding an arrow representing height 
arrow_start = (width- 50 , 20)
arrow_end = (width - 50, height - 20)
#draw arows in two dimensions
...
#diplay the annotated image 
plt.figure(figsize = (12, 8))
plt.imshow(image_rgb)
plt.title("annotated image with regions, centers and bidirectional height arrow")
plt.axis("off")
plt.show()  